...
public class Field {
	 ...
	 * @param x
	 * @param y
	 * @return true - if the tile is placed onto the field
	 * 			false - if the tile is (partly) outside the field
	 */
	 ...
	 * @param y
	 * @return true - if the tile is placed onto the field
	 * 			false - if the tile is (partly) outside the field or overlapping with another tile
	 */
	 ...
	 * @param x
	 * @param y
	 * @return true - if the square (x,y) is occupied
	 * 		   false - otherwise
	 */
