...
import generator.TilingAssignmentGenerator;
...
public class TilingProblem {
	...
	public void init(int fieldWidth, int fieldHeight, int delay,
			int scale) {
	...
	public void start() {
		...
		/**
		 * Settings: Put the delay to a value > 0
		 * You can also disable the creation of the frame to
		 * disable the GUI in total. This will allow the program
		 * to run much quicker, but you will not see the results 
		 */
