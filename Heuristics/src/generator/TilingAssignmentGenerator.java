...
public class TilingAssignmentGenerator
{
	 ...
	 * approximately numTiles tiles. The number of actual tiles used will
	 * usually be slightly higher than the number of requested tiles.
	 * 
	 * @param numTiles
	 *            - The approximate number of tiles to use
	 * @param size
