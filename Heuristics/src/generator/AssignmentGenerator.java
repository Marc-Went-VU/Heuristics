...
public class AssignmentGenerator
{
	...
	private void saveAssignmentToFile(TilingAssignment assignment, int tiles, int settings, int number)
	{
		try
		{
	...
	private void setGeneratorSettings(TilingAssignmentGenerator generator, int settings)
	{
		switch (settings)
		{
		default:
	...
	private TilingAssignment createAssignment(TilingAssignmentGenerator generator, Random random, int tiles)
	{
		...
		String val = String.format("%d hours, %d minutes, %d seconds, %d milliseconds", hours, minutes, seconds, duration);
